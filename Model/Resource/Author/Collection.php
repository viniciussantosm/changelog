...
class BIS2BIS_Changelog_Model_Resource_Author_Collection extends Varien_Data_Collection {
    ...
    public function fetch()
    {
        ...
        curl_setopt($curl, CURLOPT_HTTPHEADER, array(
            "Authorization: {$this->getConfig()->getWpUser()}:{$this->getConfig()->getWpPass()}",
